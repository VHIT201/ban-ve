...
async function middleware(request) {
    ...
    // Define route types
    const isPublicRoute = pathname === "/" || pathname.startsWith("/detail") || pathname.startsWith("/collections") || pathname.startsWith("/search") || pathname.startsWith("/terms") || pathname.startsWith("/privacy") || pathname.startsWith("/contact") || pathname.startsWith("/cookie-policy") || pathname.startsWith("/_next") || pathname.startsWith("/api") || pathname.startsWith("/static");
    const isAuthRoute = pathname.startsWith("/auth");
    const isProtectedRoute = pathname.startsWith("/profile") || pathname.startsWith("/downloads") || pathname.startsWith("/payment") || pathname.startsWith("/setting");
    ...
    if (!session && refreshToken) {
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8000/api")}/auth/refresh`, {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                const nextResponse = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
