...
export const getGetApiContactsInfiniteQueryKey = (
  params?: GetApiContactsParams,
) => {
  return ["infinite", `/api/contacts`, ...(params ? [params] : [])] as const;
};
...
export const getGetApiContactsInfiniteQueryOptions = <
  TData = InfiniteData<
    Awaited<ReturnType<typeof getApiContacts>>,
    GetApiContactsParams["page"]
  >,
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetApiContactsInfiniteQueryKey(params);
  ...
  const queryFn: QueryFunction<
    ...
    GetApiContactsParams["page"]
  > = ({ signal, pageParam }) =>
    getApiContacts({ ...params, page: pageParam || params?.["page"] }, signal);
...
export type GetApiContactsInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContacts>>
>;
export type GetApiContactsInfiniteQueryError = ErrorType<unknown>;

export function useGetApiContactsInfinite<
  TData = InfiniteData<
    Awaited<ReturnType<typeof getApiContacts>>,
    GetApiContactsParams["page"]
  >,
  TError = ErrorType<unknown>,
>(
  params: undefined | GetApiContactsParams,
  options: {
    query: Partial<
      UseInfiniteQueryOptions<
        Awaited<ReturnType<typeof getApiContacts>>,
...
export const getGetApiContactsQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContacts>>,
  TError = ErrorType<unknown>,
>(
  params?: GetApiContactsParams,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiContacts>>, TError, TData>
    >;
  },
) => {
  const { query: queryOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiContacts>>> = ({
    signal,
  }) => getApiContacts(params, signal);
...
export type GetApiContactsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContacts>>
>;
export type GetApiContactsQueryError = ErrorType<unknown>;

export function useGetApiContacts<
  TData = Awaited<ReturnType<typeof getApiContacts>>,
  TError = ErrorType<unknown>,
>(
  params: undefined | GetApiContactsParams,
 ...
 */
export const getApiContactsExport = (signal?: AbortSignal) => {
  return mainInstance<void>({
...
export const getGetApiContactsExportInfiniteQueryKey = () => {
  return ["infinite", `/api/contacts/export`] as const;
};
...
export const getGetApiContactsExportInfiniteQueryOptions = <
  TData = InfiniteData<Awaited<ReturnType<typeof getApiContactsExport>>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<
    UseInfiniteQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetApiContactsExportInfiniteQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getApiContactsExport>>
  > = ({ signal }) => getApiContactsExport(signal);
...
export type GetApiContactsExportInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContactsExport>>
>;
export type GetApiContactsExportInfiniteQueryError = ErrorType<unknown>;

export function useGetApiContactsExportInfinite<
  TData = InfiniteData<Awaited<ReturnType<typeof getApiContactsExport>>>,
  TError = ErrorType<unknown>,
>(
  options: {
...
export const getGetApiContactsExportQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContactsExport>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<
    UseQueryOptions<
...
export type GetApiContactsExportQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContactsExport>>
>;
export type GetApiContactsExportQueryError = ErrorType<unknown>;

export function useGetApiContactsExport<
  TData = Awaited<ReturnType<typeof getApiContactsExport>>,
  TError = ErrorType<unknown>,
>(
  options: {
...
export const postApiContactsExportSelected = (
  ...
  return mainInstance<void>({
    url: `/api/contacts/export/selected`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
    data: postApiContactsExportSelectedBody,
    signal,
  });
};

export const getPostApiContactsExportSelectedMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PostApiContactsExportSelectedMutationResult = NonNullable<
  Awaited<ReturnType<typeof postApiContactsExportSelected>>
>;
export type PostApiContactsExportSelectedMutationBody =
  BodyType<PostApiContactsExportSelectedBody>;
export type PostApiContactsExportSelectedMutationError = ErrorType<unknown>;

/**
 * @summary Xuất Excel theo danh sách IDs chọn lọc (Admin)
 */
export const usePostApiContactsExportSelected = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getPostApiContactsExportSelectedMutationOptions(options);
 ...
 */
export const getApiContactsId = (id: string, signal?: AbortSignal) => {
  return mainInstance<void>({
    url: `/api/contacts/${id}`,
    method: "GET",
    signal,
...
export const getGetApiContactsIdInfiniteQueryOptions = <
  TData = InfiniteData<Awaited<ReturnType<typeof getApiContactsId>>>,
  TError = ErrorType<unknown>,
>(
  id: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetApiContactsIdInfiniteQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getApiContactsId>>
  > = ({ signal }) => getApiContactsId(id, signal);
...
export type GetApiContactsIdInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContactsId>>
>;
export type GetApiContactsIdInfiniteQueryError = ErrorType<unknown>;

export function useGetApiContactsIdInfinite<
  TData = InfiniteData<Awaited<ReturnType<typeof getApiContactsId>>>,
  TError = ErrorType<unknown>,
>(
  id: string,
...
export const getGetApiContactsIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContactsId>>,
  TError = ErrorType<unknown>,
>(
  id: string,
  options?: {
...
export type GetApiContactsIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContactsId>>
>;
export type GetApiContactsIdQueryError = ErrorType<unknown>;

export function useGetApiContactsId<
  TData = Awaited<ReturnType<typeof getApiContactsId>>,
  TError = ErrorType<unknown>,
>(
  id: string,
 ...
 */
export const deleteApiContactsId = (id: string) => {
  return mainInstance<void>({ url: `/api/contacts/${id}`, method: "DELETE" });
};

export const getDeleteApiContactsIdMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteApiContactsIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteApiContactsId>>
>;
...
export const getPatchApiContactsIdReadMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PatchApiContactsIdReadMutationResult = NonNullable<
  Awaited<ReturnType<typeof patchApiContactsIdRead>>
>;
export type PatchApiContactsIdReadMutationBody =
  BodyType<PatchApiContactsIdReadBody>;
export type PatchApiContactsIdReadMutationError = ErrorType<unknown>;

/**
 * @summary Cập nhật trạng thái đã đọc thủ công (Admin)
 */
export const usePatchApiContactsIdRead = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(
  options?: {
