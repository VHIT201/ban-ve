...
/**
 * @summary Lấy lịch sử thanh toán (Hỗ trợ Guest qua orderCode/email)
 */
...
/**
 * @summary Lấy danh sách thanh toán (Admin or Guest search)
 */
...
export const getApiPaymentsPaymentId = (
    paymentId: string,
    params?: GetApiPaymentsPaymentIdParams,
 signal?: AbortSignal
) => {
      
      
      return mainInstance<GetApiPaymentsPaymentId200>(
      {url: `/api/payments/${paymentId}`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getGetApiPaymentsPaymentIdInfiniteQueryKey = (paymentId?: string,
    params?: GetApiPaymentsPaymentIdParams,) => {
    return [
    'infinite', `/api/payments/${paymentId}`, ...(params ? [params]: [])
    ] as const;
    }
...
export const getGetApiPaymentsPaymentIdQueryKey = (paymentId?: string,
    params?: GetApiPaymentsPaymentIdParams,) => {
    return [
    `/api/payments/${paymentId}`, ...(params ? [params]: [])
    ] as const;
    }

    
export const getGetApiPaymentsPaymentIdInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, GetApiPaymentsPaymentIdParams['page']>, TError = ErrorType<unknown>>(paymentId: string,
    params?: GetApiPaymentsPaymentIdParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData, QueryKey, GetApiPaymentsPaymentIdParams['page']>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiPaymentsPaymentIdInfiniteQueryKey(paymentId,params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, QueryKey, GetApiPaymentsPaymentIdParams['page']> = ({ signal, pageParam }) => getApiPaymentsPaymentId(paymentId,{...params, 'page': pageParam || params?.['page']}, signal);

      

      

   return  { queryKey, queryFn, enabled: !!(paymentId), ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData, QueryKey, GetApiPaymentsPaymentIdParams['page']> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetApiPaymentsPaymentIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, GetApiPaymentsPaymentIdParams['page']>, TError = ErrorType<unknown>>(
 paymentId: string,
    params: undefined |  GetApiPaymentsPaymentIdParams, options: { query:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData, QueryKey, GetApiPaymentsPaymentIdParams['page']>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>,
          TError,
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, QueryKey
        > , 'initialData'
      >, }
 , queryClient?: QueryClient
  ):  DefinedUseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetApiPaymentsPaymentIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, GetApiPaymentsPaymentIdParams['page']>, TError = ErrorType<unknown>>(
 paymentId: string,
    params?: GetApiPaymentsPaymentIdParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData, QueryKey, GetApiPaymentsPaymentIdParams['page']>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>,
          TError,
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, QueryKey
...
export function useGetApiPaymentsPaymentIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, GetApiPaymentsPaymentIdParams['page']>, TError = ErrorType<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiPaymentsPaymentIdInfiniteQueryOptions(paymentId,params,options)
...
export const getGetApiPaymentsPaymentIdQueryOptions = <TData = Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError = ErrorType<unknown>>(paymentId: string,
    params?: GetApiPaymentsPaymentIdParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiPaymentsPaymentIdQueryKey(paymentId,params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>> = ({ signal }) => getApiPaymentsPaymentId(paymentId,params, signal);
...
export function useGetApiPaymentsPaymentId<TData = Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError = ErrorType<unknown>>(
 paymentId: string,
    params: undefined |  GetApiPaymentsPaymentIdParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>,
          TError,
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>
...
export function useGetApiPaymentsPaymentId<TData = Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError = ErrorType<unknown>>(
 paymentId: string,
    params?: GetApiPaymentsPaymentIdParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError, TData>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>,
          TError,
          Awaited<ReturnType<typeof getApiPaymentsPaymentId>>
...
export function useGetApiPaymentsPaymentId<TData = Awaited<ReturnType<typeof getApiPaymentsPaymentId>>, TError = ErrorType<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiPaymentsPaymentIdQueryOptions(paymentId,params,options)
