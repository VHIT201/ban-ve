...
export const TransactionList = () => {
  ...
  const transactions = useMemo(() => {
    ...
    return paymentHistory.data.map((payment: any) => {
      const paymentId =
        payment._id || `temp-${Math.random().toString(36).substr(2, 9)}`;
  ...
  return (
    <div className="space-y-6">
      ...
      {paymentHistory?.pagination &&
        ...
        paymentHistory.pagination.total > 0 && (
          <div className="flex items-center justify-between px-2 py-4">
            <div className="flex-1 flex justify-between sm:hidden">
              ...
              <Button
                ...
                onClick={() => goToPage(currentPage + 1)}
                disabled={
                  currentPage === paymentHistory.pagination.totalPages ||
                  isLoading ||
                  isRefetching
                }
              >
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      ...
                      goToPage(paymentHistory.pagination.totalPages)
                    }
                    disabled={
                      !paymentHistory?.pagination?.totalPages ||
                      currentPage === paymentHistory.pagination.totalPages ||
