...
import { useCategoryTableColumnsDefs } from "../_components/category-table/lib/hooks";
...
export const CategoryDetail = () => {
  ...
  const columns = useCategoryTableColumnsDefs({
    ...
    onDelete: (category: any) => setCategoryToDelete(category),
    onEdit: (category: any) => setCategoryToEdit(category),
  });
