      ...
      <CardHeader>
        ...
        <CardAction className="w-full flex justify-end">
          ...
          <div className="hidden md:block">
            ...
            >
              <ToggleGroupItem value="90d" className="px-4 py-2">
                3 tháng
              </ToggleGroupItem>
              <ToggleGroupItem value="30d" className="px-4 py-2">
                30 ngày
              </ToggleGroupItem>
              <ToggleGroupItem value="7d" className="px-4 py-2">
                7 ngày
              </ToggleGroupItem>

              <Popover>
                <PopoverTrigger asChild>
                  <ToggleGroupItem value="custom" className="px-4 py-2">
                    Tùy chỉnh
                  </ToggleGroupItem>
                </PopoverTrigger>
              ...
              >
                {[
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setTimeRange && setTimeRange(item.value as TimeRange)
                    }
                  >
                    {item.label}
                  </Button>
