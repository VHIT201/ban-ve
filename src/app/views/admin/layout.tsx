...
const filter = "";
const type: AppType = "all";
const initSort: "asc" | "desc" = "asc";

const defaultOpen = Boolean(filter || type !== "all" || initSort !== "asc");

const Admin = () => {
  const [sort] = useState(initSort);
  const [appType] = useState(type);
  const [searchTerm] = useState(filter);
