...
import { ArrowLeft, Loader2, Lock, MailWarningIcon, User } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[400px] p-6">
        ...
        {error && (
          <div className="p-3 text-sm text-red-600 bg-red-50 rounded-md flex items-start gap-2">
            <MailWarningIcon size={18} className="mt-0.5 flex-shrink-0" />
            <span>{error}</span>
          </div>
        )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                type="password"
                placeholder={
                  isChangingPassword ? "Mật khẩu hiện tại" : "Nhập mật khẩu"
                }
                value={password}
                ...
                <div className="mt-4 text-xs text-muted-foreground bg-muted/30 p-2 rounded-md">
                  ...
                  <p>
                    ...
                    <span className="font-mono">
                      lenguyenhoang9.10@gmail.com
                    </span>
                  </p>
                  <p>
                    Mật khẩu: <span className="font-mono">lehoang123</span>
                  </p>
                </div>
              )}
