...
import { useUploaderContext } from "@/components/shared/uploader/lib/hooks";
      ...
      >
        {mediaList?.map((media, index) => (
          <div
            ...
            className="group/image relative h-full w-full overflow-hidden rounded-lg"
          >
            <img
              width={1200}
              height={250}
