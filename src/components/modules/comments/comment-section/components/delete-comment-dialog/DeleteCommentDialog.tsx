...
import { useDeleteApiComment } from '@/api/endpoints/comment'
...
const DeleteCommentDialog: FC<Props> = (props) => {
  ...
  // Mutations
  const deleteCommentMutation = useDeleteApiComment()
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button variant='destructive' loading={deleteCommentMutation.isPending} onClick={handleDeleteComment}>
